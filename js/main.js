...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.contact__form-content', rules2, afterForm);
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.modal-form', rules2, afterForm);
...
const validateForms = (selector, rules, afterSend) => {
  ...
  validation.onSuccess(ev => {
    ...
    // закрываем модальное окно Спасибо по кнопке
    ...
    closeModalThanks();
    // закрываем модальное окно Спасибо автоматически
    setTimeout(() => {
      const modalThanks = document.querySelector('.modal__thanks');
      modalThanks.classList.remove('active');
    }, 2700);
